...
export default function MatchmakingPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      calculateMatches(ngosRes.data.ngos || [], projectsRes.data.projects || []);
    } catch (error) {
  ...
  const calculateAlignment = (ngo, project) => {
    ...
    score += (commonFocus.length / ngoFocus.length) * 40;
  ...
  return (
    <div className="matchmaking-container">
      <div className="matchmaking-header">
        ...
        <p>Discover perfect partnerships between NGOs and CSR initiatives</p>
      </div>
